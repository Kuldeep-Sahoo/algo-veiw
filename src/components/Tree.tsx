...
export default function TreeVisualization() {
  ...
  useEffect(() => {
    ...
    const defaultTree: TreeState = {
      nodes: {
        A: { id: "A", value: "A", x: 300, y: 50, left: "B", right: "C" },
        B: {
          id: "B",
          value: "B",
          x: 200,
        ...
        C: { id: "C", value: "C", x: 400, y: 120, parent: "A", left: "F" },
        D: { id: "D", value: "D", x: 150, y: 190, parent: "B" },
        E: { id: "E", value: "E", x: 250, y: 190, parent: "B" },
        F: { id: "F", value: "F", x: 350, y: 190, parent: "C" },
      },
      root: "A",
    };
