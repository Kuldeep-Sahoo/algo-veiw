...
export default function App() {
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-between p-6 space-y-8">
      <div className="flex-1 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-4xl mt-8">
          {/* Graph Visualization */}
          <Link to="/graph">
            <div className="bg-gray-800 p-6 rounded-2xl shadow-lg hover:scale-105 transition-transform cursor-pointer flex flex-col items-center justify-center space-y-4">
          ...
          <div className="bg-gray-800 p-6 rounded-2xl shadow-lg flex flex-col items-center justify-center space-y-4 opacity-70 cursor-not-allowed">
